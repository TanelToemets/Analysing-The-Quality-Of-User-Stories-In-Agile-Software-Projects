...
no_splits = 67  #67 sprints (two week period 673/10)
...
for t in range(0, no_splits):
    ...
    #rs = [crosscorr(d1,d2, lag) for lag in range(-34,34)]
    rs = [crosscorr(d1,d2, lag) for lag in range(-14,15)]
    rss.append(rs)
...
ax.set(title=f'Windowed Time Lagged Cross Correlation for XD',xlim=[0,30], xlabel='Offset',ylabel='Window epochs')
