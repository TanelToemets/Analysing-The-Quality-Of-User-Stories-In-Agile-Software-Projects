...
project_output.to_csv("C://Users/Tanel/Documents/Ylikool/Magister/Master Thesis//Analysing ASP Repo/data/cleaned_input_data/jira-{0}-allus-ALL.csv".format(project), sep=',', encoding='utf-8', doublequote = True, header=False, index=False, line_terminator=",\n")
