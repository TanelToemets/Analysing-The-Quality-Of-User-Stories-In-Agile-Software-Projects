...
project_output.to_csv("C://Users/Tanel/Documents/Ylikool/Magister/Master Thesis//Analysing ASP Repo/data/cleaned_input_data/jira-xd-allus-DS.csv", sep=',', encoding='utf-8', doublequote = True, header=False, index=False, line_terminator=",\n")
