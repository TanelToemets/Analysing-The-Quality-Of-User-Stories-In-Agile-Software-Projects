...
stories_project = pd.read_csv("C:/Users/Tanel/Documents/Ylikool/Magister/Master Thesis/Analysing ASP Repo/data/cleaned_input_data/jira-dnn-allus.csv", names=['title', 'key', 'z'])
print(len(stories_project))

#Read the quality (AQUSA output)
quality_project = pd.read_csv("C:/Users/Tanel/Documents/Ylikool/Magister/Master Thesis/Analysing ASP Repo/data/analyzed_output_data/dnn-quality-allus.csv")
...
q = quality_df[["key", "penalty", "high", "medium", "minor"]].groupby(['key']).sum()
q = q.reset_index()
...
initial_dataset = initial_dataset[initial_dataset['project'] == 'dnn']
